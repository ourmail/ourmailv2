...
<div class="container">
	<h1 style= "font-family: 'Comfortaa', Arial;">Change Password</h1>
	<div  class="passwordResetContainer">
		...
		<button class="btn btn-default" id="passwordResetButton" style= "font-family: 'Comfortaa', Arial;">Request Password Change</button>
	</div>
</div>