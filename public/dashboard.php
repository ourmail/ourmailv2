...
<body>
		...
		<nav class="navbar navbar-default">
			<div class="container-fluid">
				...
				<div class="navbar-header">
					<a class="navbar-brand" href="#" id="email_button">Ourmail</a>
				</div>
				...
				<div>
					...
					<ul class="nav navbar-nav navbar-right">
						<div class="dropdown">
							<button class="btn btn-default dropdown-toggle" type="button" id="currentUserName" id="dropdownMenu1" data-toggle="dropdown" >
							username
								<span class="caret"></span>
							</button>
							<ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
								<li><a href="#" id="account_button">Account Management</a></li>
	...
	<div id="email_dashboard_container">
		<div id="email_folder_sidebar" class="col-md-2 sidebar">
			<!-- Email Sidebar Area -->
			<!--
		...
		<div id="email_main_display_container" class="col-md-10 main">
			<!-- Email Display Area -->
		</div>
	</div>
	...
	<div id="account_management_container">
		<div id="account_management_sidebar" class="col-xs-12 col-md-3">
			<ul>
				...
				<li class="list-group-item" id="theme_link"><a href="#">Theme</a></li>
			</ul>
		</div>
